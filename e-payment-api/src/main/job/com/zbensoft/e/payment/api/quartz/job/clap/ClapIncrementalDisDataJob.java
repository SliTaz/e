 ...
 *
 */
public class ClapIncrementalDisDataJob extends ClapIncrementalAbs implements Job {
	
	private static final Logger log = LoggerFactory.getLogger(ClapIncrementalDisDataJob.class);
