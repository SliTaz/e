 ...
 *
 */
public class ClapIncrementalSellerDataJob extends ClapIncrementalAbs implements Job {
	
	private static final Logger log = LoggerFactory.getLogger(ClapIncrementalSellerDataJob.class);
