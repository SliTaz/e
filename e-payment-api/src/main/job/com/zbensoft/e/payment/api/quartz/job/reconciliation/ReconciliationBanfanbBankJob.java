 ...
 *
 */
public class ReconciliationBanfanbBankJob extends SimpleReconciliationJobAbs {
	Logger logger = LoggerFactory.getLogger(getClass());

	private static String key = ReconciliationBanfanbBankJob.class.getName();
	...
	protected void initdata() {
		super.key = ReconciliationBanfanbBankJob.key;
		...
		bankId = "0177";
		filePath = JOB_RECONCLIATION_ALL_BANK_FILE_PATH + "/banfanb/Conciliation_recharge/";
		bankFilePath = JOB_RECONCLIATION_ALL_BANK_BANK_FILE_PATH + "/banfanb/Conciliation_recharge/";
		timeWindow = 0;// 时间窗口
		// other
