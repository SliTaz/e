 ...
 *
 */
public class ReconciliationBicentennialBankJob extends SimpleReconciliationJobAbs {
	Logger logger = LoggerFactory.getLogger(getClass());

	private static String key = ReconciliationBicentennialBankJob.class.getName();
	...
	protected void initdata() {
		super.key = ReconciliationBicentennialBankJob.key;
		...
		bankId = "0175";
		filePath = JOB_RECONCLIATION_ALL_BANK_FILE_PATH + "/bicentennial/Conciliation_recharge/";
		bankFilePath = JOB_RECONCLIATION_ALL_BANK_BANK_FILE_PATH + "/bicentennial/Conciliation_recharge/";
		timeWindow = 0;// 时间窗口
		// other
