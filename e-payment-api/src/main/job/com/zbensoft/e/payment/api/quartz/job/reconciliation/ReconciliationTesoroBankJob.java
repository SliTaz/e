 ...
 *
 */
public class ReconciliationTesoroBankJob extends SimpleReconciliationJobAbs {
	Logger logger = LoggerFactory.getLogger(getClass());

	private static String key = ReconciliationTesoroBankJob.class.getName();
	...
	protected void initdata() {
		super.key = ReconciliationTesoroBankJob.key;
		...
		bankId = "0163";
		filePath = JOB_RECONCLIATION_ALL_BANK_FILE_PATH + "/treasure/Conciliation_recharge/";
		bankFilePath = JOB_RECONCLIATION_ALL_BANK_BANK_FILE_PATH + "/treasure/Conciliation_recharge/";
		timeWindow = 0;// 时间窗口
		// other
