 ...
 *
 */
public class ReconciliationVenezuelaBankJob extends SimpleReconciliationJobAbs {
	Logger logger = LoggerFactory.getLogger(getClass());

	private static String key = ReconciliationVenezuelaBankJob.class.getName();
	...
	protected void initdata() {
		super.key = ReconciliationVenezuelaBankJob.key;
		...
		bankId = "0102";
		filePath = JOB_RECONCLIATION_ALL_BANK_FILE_PATH + "/venezuela/Conciliation_recharge/";
		bankFilePath = JOB_RECONCLIATION_ALL_BANK_BANK_FILE_PATH + "/venezuela/Conciliation_recharge/";
		timeWindow = 0;// 时间窗口
		// other
