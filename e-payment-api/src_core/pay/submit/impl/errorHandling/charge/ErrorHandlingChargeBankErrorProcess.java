 ...
 *
 */
public class ErrorHandlingChargeBankErrorProcess extends AbsSubmitPayProcess {

	private static final Logger log = LoggerFactory.getLogger(ErrorHandlingChargeBankErrorProcess.class);
	...
	public ResponseRestEntity<ErrorHandlingBankChargeErrorResponse> payProcess(Object request) {
		...
		submitTradeInfo.setErrorCode(MessageDef.TRADE_ERROR_CODE.CHARGE_BANK_NO_RECORD);
