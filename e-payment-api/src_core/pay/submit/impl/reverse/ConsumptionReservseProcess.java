package org.e.payment.core.pay.submit.impl.reverse;
 ...
 */
public class ConsumptionReservseProcess extends AbsSubmitPayProcess {

	private static final Logger log = LoggerFactory.getLogger(ConsumptionReservseProcess.class);
