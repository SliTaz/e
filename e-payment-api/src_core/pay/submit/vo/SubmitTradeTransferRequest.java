...
public class SubmitTradeTransferRequest {

	private String payAppId;
	private String orderNo;// fix：123
	private String tradeType;// 交易类型3转账
	private String bankBindId;// 快捷支付，绑定的银行卡编号，可以为空，空：使用余额转账
	private String payUserId;// 当前登录用户
//	private String payUserName;
	private String payAmount;
	private String payFee;
//	private String recvUserId;// 收款用户编号
	private String recvUserName;// 收款用户名
...
//	}
	...
	public String toString() {
		...
		sb.append("SubmitTradeTransferRequest").append("=").append("[");
