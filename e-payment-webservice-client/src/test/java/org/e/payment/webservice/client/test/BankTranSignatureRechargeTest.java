...
@SpringBootTest
public class BankTranSignatureRechargeTest {
	...
	public void recharge() {
		...
		bankPaymentInfo.setPaymentTime(DateUtil.convertDateToString(Calendar.getInstance().getTime(), DateUtil.DATE_FORMAT_SEVENTEEN));
		bankPaymentInfo.setVid("V12962724");
